console.log(document.getElementById('candlestick'));
var myChart = echarts.init(document.getElementById('candlestick'));
//alert("loadok!");
//app.title = '2015 ÄêÉÏÖ¤Ö¸Êý';
...
var myChart = echarts.init(document.getElementById('candlestick1'));
...
var myChart = echarts.init(document.getElementById('candlestick2'));
option2 = {
    tooltip : {
        trigger: 'axis'
    },
